...
[English](https://github.com/adrianbiro/hugo-theme-mini/tree/master/README.md) | 简体中文
...
- [示例网站源码](https://github.com/adrianbiro/hugo-theme-mini/tree/master/exampleSite)
...
在 [`exampleSite`](https://github.com/adrianbiro/hugo-theme-mini/tree/master/exampleSite) 目录中有一个 [`config.yaml`](https://github.com/adrianbiro/hugo-theme-mini/blob/master/exampleSite/config.yaml) 的配置文件，你可以将其复制到你的项目根目录中，将一些配置项修改为你的配置。这些配置都可以随意修改。
